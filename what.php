...
<div class="main">
<main>
<h2 class="mainHeading">getSEMantic: Alchemy Term Extraction API</h2>
<p>This is a proof of concept app and teaching demo. The app shows the top entities and linked data sources extracted from a given URL. Built with PHP, HTML/CSS, and Alchemy Content Analysis API.</p>
</main>
</div><!--end .main div-->
<aside>
	<h3>Key:</h3>
